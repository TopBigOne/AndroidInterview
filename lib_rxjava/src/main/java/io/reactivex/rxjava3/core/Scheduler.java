...
public abstract class Scheduler {
    ...
    /**
     * Retrieves or creates a new {@link Worker} that represents sequential execution of actions.
     * <p>
     * When work is completed, the {@code Worker} instance should be released
     * by calling {@link Worker#dispose()} to avoid potential resource leaks in the
     * underlying task-execution scheme.
     * <p>
     * Work on a {@link Worker} is guaranteed to be sequential and non-overlapping.
     *

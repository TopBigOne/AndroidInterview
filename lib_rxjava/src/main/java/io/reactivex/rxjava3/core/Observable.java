...
public abstract class Observable<@NonNull T> implements ObservableSource<T> {
     ...
     * previously seen items and uses {@link Set#add(Object)} returning {@code false} as the
     ...
     * <p>
     * Customizing the retention policy can happen only by providing a custom {@link Collection} implementation
     ...
     * <p>
     * By default, {@code distinct()} uses an internal {@link HashSet} per {@link Observer} to remember
     * previously seen keys and uses {@link Set#add(Object)} returning {@code false} as the
     * indicator for duplicates.
     * <p>

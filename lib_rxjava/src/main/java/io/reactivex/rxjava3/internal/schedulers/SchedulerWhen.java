 ...
 * <p>
 * When the {@link Worker Worker} is unsubscribed the {@link Completable} emits an
 ...
 * the number of concurrent {@link Worker Worker}s rather than individual actions.
 * Generally each {@link Observable} uses its own {@link Worker Worker}. This means

 ...
 * <p>
 * Since a {@code MaybeSubject} is a {@link Maybe}, calling {@code onSuccess}, {@code onError}
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code MaybeSubject} does not operate by default on a particular {@link Scheduler} and
 ...
 *  {@link RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code MaybeObserver}s
 *  cancel at once).

 ...
 * <p>
 * Since a {@code SingleSubject} is a {@link Single}, calling {@code onSuccess} or {@code onError}
 ...
 * the {@link RxJavaPlugins#onError(Throwable)} global error handler.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code SingleSubject} does not operate by default on a particular {@link Scheduler} and
 ...
 *  {@link RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code SingleObserver}s
 *  cancel at once).

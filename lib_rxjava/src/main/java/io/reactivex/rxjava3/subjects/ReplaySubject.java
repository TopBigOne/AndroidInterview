 ...
 * late {@link Observer}s will receive the retained/cached items first (if any) followed by the respective
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code ReplaySubject} does not operate by default on a particular {@link Scheduler} and
 ...
 *  {@link RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code Observer}s
 *  cancel at once).

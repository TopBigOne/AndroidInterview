...
public final class Schedulers {
     ...
     * annotation.
     * <p>
     * When the {@link Scheduler.Worker Scheduler.Worker} is disposed,
     ...
     * <p>
     * Tasks submitted to the {@link Scheduler.Worker Scheduler.Worker} of this {@code Scheduler} are also not interruptible. Use the
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link Scheduler.Worker Scheduler.Worker} instances, although
     * not disposing a worker that has timed/delayed tasks not cancelled by other means may leak resources and/or
     * execute those tasks "unexpectedly".
     * <p>
     ...
     * calls to it.
     * <p>
     * The tasks scheduled by the returned {@code Scheduler} and its {@link Scheduler.Worker Scheduler.Worker}
     ...
     * @param executor
     *          the executor to wrap
     * @param interruptibleWorker if {@code true} the tasks submitted to the {@link Scheduler.Worker Scheduler.Worker} will

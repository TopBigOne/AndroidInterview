package dp.packsack.leet_code_416;
...
public class CanPartition {
    ...
    public boolean canPartition10(int[] nums) {
        int length = nums.length;
        int sum = 0;
        for (int num : nums) {
            sum += num;
        ...
        if (firstNumsValue <= target) {
            dp[firstNumsValue] = true;
        }
    ...
    public boolean canPartttion11(int[] nums) {
        int length = nums.length;
        int sum = 0;
        for (int num : nums) {
            sum += num;
    ...
    public boolean canPartition12(int[] nums) {
        int length = nums.length;
        int sum = 0;
        for (int num : nums) {
            sum += num;

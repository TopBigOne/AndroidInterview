 ...
 * @version :
 * @Date :   2022/1/5 18:22
 * @Url :https://leetcode-cn.com/problems/design-twitter/solution/
 * @Level :    medium
 * @Desc : 设计Twitter;
 * @Counter :
 * @Answer :https://labuladong.gitee.io/algo/2/20/48/
 *
...
public class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        ...
        PriorityQueue<Tweet> pq =
                new PriorityQueue<>(users.size(), (a, b) -> (int) (b.time - a.time));
